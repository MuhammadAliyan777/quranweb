            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li><a href="events_request.php"><i class="fa fa-paper-plane yellow_color"></i><span>Events</span></a></li>
                     <li><a href="operations.php"><i class="fa fa-solid fa-plus"></i><span>Operations</span></a></li>
                     <li>
                        <a href="contact.html">
